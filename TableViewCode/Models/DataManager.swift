...
class DataManager {
    ...
    func makeMovieData() {
        movieDataArray = [Movie(movieImage: UIImage(named: "batman.png"), movieName: "배트맨", movieDescription: "배트맨이 출현하는 영화"),
    ...
    func updateMovieData() {
        let movie = Movie(movieImage: "spiderman2.png", movieName: "스파이더맨2", description: "스파이더맨 시즌2")
    }
